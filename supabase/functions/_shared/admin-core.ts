/**
 * NÃºcleo compartido del agente admin. Lo usan tanto el server function de
 * TanStack (npm run dev) como la Edge Function admin-agent (Deno), asÃ­ que
 * aquÃ­ solo puede haber imports neutros: la reserva Groq. Los schemas zod
 * viven en cada consumidor porque Deno necesita el prefijo npm:.
 */
